(function (global, factory) {
  ...
  */
  ...
  ConditionChecker.$inject = ['formFieldRegistry'];
    ...
    validateField(field, value) {
      ...
      if ('enforceStep' in validate && value && field.step) {
        ...
        if (2 * Number.EPSILON < inaccuracy) {
          ...
          errors = [...errors, `Please select a valid value, the two nearest valid values are ${parseFloat(previousValue.toFixed(decimalDigits))} and ${parseFloat(followingValue.toFixed(decimalDigits))}.`];
        }
      }
  ...
  const TIME_SERIALISINGFORMAT_PATH = ['timeSerializingFormat'];
  ...
  class Importer {
    ...
    importData(data) {
      return this._formFieldRegistry.getAll().reduce((importedData, formField) => {
        ...
        ['readonly', 'label', 'condition'].forEach(property => {
  ...
  function sanitizeSingleSelectValue$1(options) {
    const {
      formField,
      data,
      value
  ...
  function Checkbox(props) {
    ...
    return e$2("div", {
      class: classNames(formFieldClasses(type$b, errors), {
        readonly
      }),
      children: [e$2(Label, {
        ...
        children: e$2("input", {
          checked: value,
          class: "fjs-input" // todo(pinussilvestrus): a11y concerns?
          ,
  ...
  function parseIsoTime(isoTimeString) {
    ...
    const localOffset = new Date().getTimezoneOffset(); // Parse normalized time
    ...
    if (isoTimeString.includes('Z')) {
      ...
      if (minutes === null || inboundOffset === null) return null; // The offset is flipped for consistency with javascript
  ...
  function serializeDateTime(date, time, timeSerializingFormat) {
    ...
    if (timeSerializingFormat === TIME_SERIALISING_FORMATS.UTC_NORMALIZED) {
      ...
      const dayOffset = time + timezoneOffsetMinutes < 0 ? -1 : time + timezoneOffsetMinutes > MINUTES_IN_DAY ? 1 : 0; // Apply the date rollover pre-emptively
  ...
  function Checklist(props) {
    ...
    return e$2("div", {
      class: classNames(formFieldClasses(type$a, errors), {
        readonly
      }),
      children: [e$2(Label, {
        label: label
        ...
        return e$2(Label, {
          ...
          children: e$2("input", {
            ...
            class: "fjs-input",
            disabled: disabled // todo(pinussilvestrus): a11y concerns?
            ,
            tabIndex: readonly ? -1 : 0,
            id: prefixId(`${id}-${index}`, formId),
            type: "checkbox",
  ...
  function useCondition(condition, data, defaultValue) {
  ...
  function useConditionEvaluation(condition, data, defaultValue) {
    const conditionChecker = useService('conditionChecker', false);
  ...
  function FormField(props) {
    ...
    const disabled = properties.readOnly || field.disabled || false; // todo(pinussilvestrus): find a general approach to retrieve conditional expression properties

    const readonly = useCondition(field.readonly, data, false); // todo(pinussilvestrus): only demo purposes, remove me later
    // eslint-disable-next-line
  ...
  function Datepicker(props) {
    ...
    const [forceRefreshValue, setForceRefreshValue] = l$1(false);
    const enterKeyboardEvent = d(() => new KeyboardEvent('keydown', {
      code: 'Enter',
      key: 'Enter',
      charCode: 13,
      keyCode: 13,
    ...
    }, [disabled, disallowPassedDates, enterKeyboardEvent]); // Shorts the date value back to the source

    y(() => {
      if (!flatpickrInstance || !flatpickrInstance.config) return;
      flatpickrInstance.setDate(date, true);
    }, [flatpickrInstance, date.toString()]); // OnChange is updated dynamically, so not to re-render the flatpicker every time it changes

    y(() => {
      if (!flatpickrInstance || !flatpickrInstance.config) return;
      flatpickrInstance.config.onChange = [date => setDate(new Date(date))];
    }, [flatpickrInstance, setDate]);
    const focusRelevantCalendarDay = A$1(e => {
      if (!flatpickrInstance) return;
      const container = flatpickrInstance.calendarContainer;
      const dayToFocus = container.querySelector('.flatpickr-day.selected') || container.querySelector('.flatpickr-day.today') || container.querySelector('.flatpickr-day'); // @ts-ignore
    ...
    }, [flatpickrInstance]); // Simulate an enter press on blur to make sure the date value is submitted in all scenarios
  ...
  function Timepicker(props) {
    ...
    const [rawValue, setRawValue] = l$1(''); // Shorts the time value back to the source
    ...
    const propagateRawToMinute = A$1(newRawValue => {
      const localRawValue = newRawValue || rawValue; // If no raw value exists, set the minute to null
      ...
      const minutes = parseInputTime(localRawValue); // If raw string couldn't be parsed, clean everything up
      ...
      const correctedMinutes = minutes - minutes % timeInterval; // Enforce the raw text to be formatted properly
    ...
    const initialFocusIndex = d(() => {
      ...
      if (!timeOptions) return null; // If there is a set minute value, we focus it in the dropdown

      if (time) return time / timeInterval; // If there is no set value, simply focus the middle of the dropdown (12:00)
    ...
    return e$2(InputAdorner, {
      ...
      children: e$2("div", {
        ...
        children: [e$2("input", {
          ...
          onClick: () => useDropdown && setDropdownIsOpen(true) // @ts-ignore
          ,
          onInput: e => {
  ...
  function Datetime(props) {
    ...
    const [dateCache, setDateCache] = l$1(getNullDate());
    const [timeCache, setTimeCache] = l$1(null);
    ...
    return e$2("div", {
      class: classNames(formFieldClasses(type$9, allErrors), {
        readonly
      }),
      children: [e$2(Label, {
        id: prefixId(id, formId),
        ...
        children: [useDatePicker && e$2(Datepicker, { ...datePickerProps
        }), useTimePicker && useDatePicker && e$2("div", {
          style: {
            width: '10px'
          }
        }), useTimePicker && e$2(Timepicker, { ...timePickerProps
        })]
      }), e$2(Description, {
        description: description
      }), e$2(Errors, {
  ...
  function useImageSource(field) {
    const {
      defaultValue,
      source: sourceKey
    } = field;
    const [source, setSource] = l$1('');

    const formData = useService('form')._getState().data; // todo(pinussilvestrus): support FEEL expressions


    y(() => {
      const dataSource = get$1(formData, [sourceKey]);
  ...
  function Number$1(props) {
    ...
    const [rawValueCache, setRawValueCache] = l$1('');
    const numberInputRef = s();
    const valueCacheMismatch = d(() => Number$1.sanitizeValue({
      value,
      formField: field
    }) !== Number$1.sanitizeValue({
      value: rawValueCache,
      formField: field
    }), [field, rawValueCache, value]);
    const displayValue = d(() => valueCacheMismatch ? value && value.toString() || '' : rawValueCache, [rawValueCache, value, valueCacheMismatch]);
    const appliedStep = d(() => step || (decimalDigits ? 1 / 10 ** decimalDigits : undefined), [decimalDigits, step]);
    ...
    const onInput = e => {
      ...
      if (decimalDigits === 0) {
        const valueAsInt = parseInt(newRawValue); // If an invalid integer was pasted in, clear
        ...
        let valueAsFloat = parseFloat(newRawValue); // If an invalid number was pasted in, clear
    ...
    return e$2("div", {
      ...
      children: [e$2(Label, {
        ...
        children: e$2("input", {
          ref: numberInputRef,
          class: classNames('fjs-input', {
            readonly
          }),
          disabled: disabled,
          id: prefixId(id, formId) // @ts-ignore
          ,
      ...
      children: [e$2(Label, {
        ...
        return e$2(Label, {
          ...
          children: e$2("input", {
            ...
            disabled: disabled,
            id: prefixId(`${id}-${index}`, formId) // todo(pinussilvestrus): a11y concerns?
            ,
            tabIndex: readonly ? -1 : 0,
            type: "radio",
  ...
  function Select(props) {
    ...
    return e$2("div", {
      ...
      children: [e$2(Label, {
        ...
        class: classNames('fjs-select', {
          readonly
        }),
        disabled: disabled,
        id: prefixId(id, formId),
        onChange: onChange // todo(pinussilvestrus): a11y concerns?
        ,
        tabIndex: readonly ? -1 : 0,
        value: value || '',
        children: [e$2("option", {
  ...
  function searchableselect(props) {
    ...
    const SelectDisplay = d(() => e$2("div", {
      class: "fjs-input-group",
      children: [e$2("span", {
        style: {
          padding: '8px',
          flexGrow: '1'
        },
        children: [valueToOptionMap[value] ? valueToOptionMap[value].label : `unexpected value{${value}}`, " "]
      }), e$2("span", {
        class: "fjs-input-adornment border-left border-radius-right",
        onClick: () => setValue(null),
        children: e$2(CloseIcon, {})
      })]
    }), [setValue, value, valueToOptionMap]);
    const SelectInput = d(() => e$2("input", {
      disabled: disabled,
      class: "fjs-input",
      ref: searchbarRef,
    ...
    }), [disabled, filter, formId, id, onInputKeyDown]);
    ...
    return e$2("div", {
      ...
      children: [e$2(Label, {
        ...
        class: classNames('fjs-searchable-select', {
          'disabled': disabled
        }),
        children: [displayState.displaySelection && SelectDisplay, displayState.displaySearch && SelectInput]
      }), e$2("div", {
    ...
    return e$2("div", {
      ...
      children: [e$2(Label, {
        ...
        children: [!disabled && loadState === LOAD_STATES.LOADED && values.map(v => {
          ...
          value: filter,
          placeholder: 'Search',
          autoComplete: "off" // todo(pinussilvestrus): a11y concerns?
          ,
          tabIndex: readonly ? -1 : 0,
          onKeyDown: e => onInputKeyDown(e),
          onMouseDown: () => setIsEscapeClose(false),
        ...
        class: "fjs-taglist-anchor",
        children: !disabled && !readonly && loadState === LOAD_STATES.LOADED && isDropdownExpanded && !isEscapeClosed && e$2(DropdownList, {
          values: filteredOptions,
          getLabel: o => o.label,
  ...
  function useText(field) {
    const {
      text: staticText,
      textRef
    } = field;
    const [text, setText] = l$1('');

    const formData = useService('form')._getState().data; // todo(skaiir): ditch in favor of FEEL when we have it


    y(() => {
      const refData = get$1(formData, [textRef]);
  ...
  function Textarea(props) {
    ...
    const autoSizeTextarea = A$1(textarea => {
      ...
      textarea.style.height = `${displayHeight}px`; // Overflow is hidden by default to hide scrollbar flickering
  ...
  const formFields = [Button, Checkbox, Checklist, Default, Datetime, Image, Number$1, Radio, searchableselect, Select, Taglist, Text, Textfield, Textarea];
